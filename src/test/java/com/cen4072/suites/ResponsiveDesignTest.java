...
public class ResponsiveDesignTest extends BaseTest {
    ...
    @Test
    @DisplayName("TC-26: Mobile menu toggle")
    ...
    @Test
    @DisplayName("TC-27: Tablet layout grid")
    ...
    @Test
    @DisplayName("TC-28: Search bar visibility on mobile")
